...
- Workshop (2017 1/4분기): Data journalism에 필요한 skill 공유
      ...
      + Data managment: Webscraping tools + Data managment 
      + Analysis: Basic Deep learning algorithm 
      + Publication: Rmarkdown + Web publication tools (Github,RPub,WIX)
